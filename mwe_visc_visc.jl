...
function eval_residual(x, composite_expanded, composite_global, state_funs, unique_funs_global, subtractor_vars, inds_x_to_subtractor, inds_args_to_x, args_template, args_all, args_solve)
...
generate_args_from_x(::SVector, ::Tuple{}, ::Tuple{Tuple{}}, ::Tuple{}) = (;)
...
function main(composite, vars, args_solve, args_other)
    ...
    R, J = value_and_jacobian(
        x -> eval_residual(x, composite_expanded, composite_global, state_funs, unique_funs_global, subtractor_vars, inds_x_to_subtractor, inds_args_to_x, args_template, args_all, args_solve), 
        AutoForwardDiff(), 
        x
    )
    J \ R
