...
@inline compute_shear_strain(r::Elasticity; τ = 0, τ0 = 0, dt = 0, kwargs...) = (τ - τ0) / (2 * r.G * dt)
...
@inline compute_volumetric_strain(r::Elasticity; P=0, P0 = 0, dt = 0, kwargs...) = (P - P0) / (r.K * dt)
